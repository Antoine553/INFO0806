...
La fonction *confint* permet d’obtenir l'intervalle de confiance à 95% pour les coefficients estimés. Cette fonction repose sur la loi de Student, ainsi l'hypothèse de normalité des résidus doit être acceptable afin que ceux-ci soient pertinents.
