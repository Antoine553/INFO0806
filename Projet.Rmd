...
Dans un premier temps nous pouvons etudier rapidement d'eventuel corrélation entre deux variables à l'aide d'un scatterplot. Ici nous utilisons la fonction ggpairs afin de pouvoir en observer plusieur en même temps.
```{r , message=FALSE}
